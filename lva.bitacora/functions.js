    ...
    function duplicateForm() {
        ...
        if(parseFloat(suma) < 100){
            ...
            mostrarModal("No puedes agregar otra actividad si tus actividades acumulan el 100%");
            return; 
        }
    ...
    function enviarForm(){
        ...
        if(parseFloat(suma) < 100){
            mostrarModal("No puedes enviar el tus actividades si tu porcentaje total es menor que 100%");
            return;
        }else{
