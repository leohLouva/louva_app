            ...
            <div class="topbar container-fluid">
                ...
                <ul class="topbar-menu d-flex align-items-center gap-3">
                    <li class="dropdown d-lg-none">
                        <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="{{ url("#") }}" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="{{ url("#") }}" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <span class="align-middle d-none d-lg-inline-block">México</span> <i class="mdi mdi-chevron-down d-none d-sm-inline-block align-middle"></i>
                        </a>
                    ...
                    <li class="dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg py-0">
                            ...
                            <div class="px-3" style="max-height: 300px;" data-simplebar>
                                ...
                                <a href="{{ url("javascript:void(0);") }}" class="dropdown-item p-0 notify-item card unread-noti shadow-none mb-2">
                                    <div class="card-body">
                                ...
                                <!-- item-->
                                <a href="{{ url("javascript:void(0);") }}" class="dropdown-item p-0 notify-item card read-noti shadow-none mb-2">
                                    <div class="card-body">
                                        <span class="float-end noti-close-btn text-muted"><i class="mdi mdi-close"></i></span>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                            ...
                            <!-- All-->
                            <a href="{{ url("javascript:void(0);") }}" class="dropdown-item text-center text-primary notify-item border-top border-light py-2">
                                View All
                            </a>
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="{{ url("#") }}" role="button" aria-haspopup="false" aria-expanded="false">
