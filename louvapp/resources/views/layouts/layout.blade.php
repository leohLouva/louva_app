                ...
                <div class="topbar container-fluid">
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-3">
                        ...
                        <li class="dropdown">
                            ...
                            <!--<div class="dropdown-menu dropdown-menu-end dropdown-menu-animated"></div>
                        </li>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarMultiLevel">
                                <ul class="side-nav-second-level">
                                    <li><a href="#" onclick="actionMenu('user','view')">Ver Usuarios</a>
                                    </li>
                                    <!--<li>
                                        <a href="javascript: void(0);">Agregar Usuarios</a>
                                    </li>-->
