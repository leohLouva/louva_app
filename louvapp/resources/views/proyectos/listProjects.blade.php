...
<div class="row mb-2">
    ...
    <div class="col-sm-8">
        <div class="text-sm-end">
            <a href="{{ route('agregar-proyecto.verAgregarProyecto') }}" class="btn btn-danger rounded-pill mb-3"><i class="mdi mdi-plus"></i>  Projecto</a>
        </div>
    </div><!-- end col-->
</div> 
<!-- end row-->
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card d-block">
                @if ($project && is_object($project) && property_exists($project, 'img_logo') && $project->img_logo == NULL)
                    <img src="{{ asset("uploads/sample.jpg") }}" style="height: 100px;" alt="avatar-2" class="rounded-circle img-thumbnail">
                @elseif ($project && is_object($project) && property_exists($project, 'img_logo'))
                    <img src="{{ asset("assets/images/users/louva_usuarios/$project->img_logo") }}" style="height: 100px;" alt="avatar-2" class="rounded-circle img-thumbnail">
                @endif
                <img class="card-img-top" src="{{ asset("/assets/images/projects/interkone-louva-pic.jpg") }}" alt="project image cap">
                ...
                <div class="card-body position-relative">
                    ...
                    <div class="mb-3" id="tooltip-container4">
                        <a href="#" class="btn btn-info rounded-pill mb-3"><i class="mdi mdi-plus"></i> Ver detalle</a></a>
                    </div>
